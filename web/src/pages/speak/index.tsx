...
const words = [
  ...
  '魔方，宛如一座等待探索者征服的思维高峰。它绝非仅仅是玩具，而是开启智慧潜能的神秘锁钥。让我们一起欣赏魔方秀～',
  '现在，让我们用欢快的歌声迎接春天',
  '请欣赏主持小班的孩子们带来儿歌《春天》，掌声有请！',
  '一支巴乌，吹出风月缠绵、民族风情。请欣赏大班提高班带来的葫芦丝吹奏《万疆》《新疆舞曲》',
        ...
        <div key={word}>
          <div
            className={classnames(styles.word, {
              [styles.speaking]: currentRowIndex === index,
            })}
          >
