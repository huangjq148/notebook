...
export default () => {
    ...
    const { dataSource, loading, searchForm } = useTable<Contact>({ request: queryContact, conditions })
    ...
    const columns = [
        ...
        },
        {
            title: '操作',
            key: "operation",
            render: (record: Contact) => <Button type="text" onClick={() => handleContactDelete(record.id as string)}>删除</Button>
        },
    ];
