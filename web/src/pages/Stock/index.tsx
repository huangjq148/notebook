...
export default () => {
    ...
    const { dataSource, loading, pagination, searchForm, handlePageChange } = useTable<Product>({ request: queryStock, conditions })
    ...
    return <div>
        ...
        <div className={styles.tableWrapper}>
            <Table rowKey="id" loading={loading} pagination={pagination} dataSource={dataSource} onChange={handlePageChange} columns={columns} />
        </div>
